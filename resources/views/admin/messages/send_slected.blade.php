        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="{{ url('admin/sendSelectedMessage/'.$handyId->id) }}" method="POST">
                        @csrf
                        <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <select name="userId" id="userId" class="form-control form-control-border">
                                                <option value="{{ $handyId->id }}">{{ $handyId->name }}</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
