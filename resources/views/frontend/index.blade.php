...
@section('content')
    ...
    <section class="slider-holder">
        <div class="flexslider carousel">
            <ul class="slides">
                <li>
                    <img src="{{ asset('asset/images/samples/slide1.jpg') }}" alt="" />
                </li>
                <li>
                    <img src="{{ asset('asset/images/samples/slide2.jpg') }}" alt="" />
                </li>
                <li>
                    <img src="{{ asset('asset/images/samples/slide3.jpg') }}" alt="" />
                </li>
            </ul>
            ...
            <div class="promobox" data-stellar-background-ratio="0.5">
                <div class="row">
                    <div class="col-md-4 promobox-item">
                        ...
                        <img src="{{ asset('asset/images/samples/worker3.png') }}" alt="" class="img-responsive">
                        <a href="#" class="btn btn-primary btn-sm">See Here</a>
                    </div>
                    <div class="col-md-4 promobox-item">
                        <h4><span>For</span> Plumbers</h4>
                        <img src="{{ asset('asset/images/samples/worker1.png') }}" alt="" class="img-responsive">
                        <a href="#" class="btn btn-primary btn-sm">See Here</a>
                    </div>
                    <div class="col-md-4 promobox-item">
                        <h4><span>For</span> Builders</h4>
                        <img src="{{ asset('asset/images/samples/worker2.png') }}" alt="" class="img-responsive">
                        <a href="#" class="btn btn-primary btn-sm">See Here</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="testimonial">
                        ...
                        <div class="bq-author">
                            <figure class="author-img">
                                <img src="{{ asset('asset/images/samples/user1-sm.jpg') }}" alt="">
                            </figure>
                            <h6>Michael Smith</h6>
                ...
                <div class="col-md-3">
                    <div class="testimonial">
                        ...
                        <div class="bq-author">
                            <figure class="author-img">
                                <img src="{{ asset('asset/images/samples/user3-sm.jpg') }}" alt="">
                            </figure>
                ...
                <div class="col-md-3">
                    <div class="testimonial">
                        ...
                        <div class="bq-author">
                            <figure class="author-img">
                                <img src="{{ asset('asset/images/samples/user2-sm.jpg') }}" alt="">
                            </figure>
                            <h6>Hanna Pinkman</h6>
                ...
                <div class="col-md-3">
                    <div class="testimonial">
                        ...
                        <div class="bq-author">
                            <figure class="author-img">
                                <img src="{{ asset('asset/images/samples/user4-sm.jpg') }}" alt="">
                            </figure>
                            <h6>Erick Fox</h6>
